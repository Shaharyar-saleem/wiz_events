          ...
          <div class="row flex-grow">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                <?php echo form_open(base_url('admin/forget/request'), $form_attributes); ?>
                  <div class="form-group">
                    <input type="email" name="email" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Username">
                  </div>
                  <div class="mt-3">
                    <button type="submit" class="btn btn-block btn-gradient-primary btn-lg font-weight-medium auth-form-btn">Send Request</button>
                  </div>
                  <div class="my-2 d-flex justify-content-between align-items-center">
                    <h6 class="text-center">we will send you a link via email to set up a new password</h6>
                  </div>
                </form>
              </div>
            </div>
