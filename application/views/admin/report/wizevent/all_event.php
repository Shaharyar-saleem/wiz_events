<div class="content-wrapper">
  <div class="page-header">
    <h3 class="page-title"> Wiz Event </h3>
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="<?= base_url('admin/dashboard') ?>">Dashboard</a></li>
        <li class="breadcrumb-item active" aria-current="page">Wiz Event</li>
      </ol>
    </nav>
  </div>

  <div class="">
    <?php foreach ($all_event as $key => $info): ?>
      <?php if (!empty($info['event_title'])): ?>
        <div class="card mb-3 position-relative">
          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-lg-9">
                <div class="d-flex">
                  <h5 class="card-title"><?= $info["event_title"] ?></h5>
                </div>
